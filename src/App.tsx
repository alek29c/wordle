...
function App() {
    ...
    return (
        <div className="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <Alert message="Зборот не е пронајден во речникот на Зборче" isOpen={isWordNotFoundAlertOpen} />
            ...
            <div className="flex w-80 mx-auto items-center mb-2">
                ...
                <h1 className="text-4xl text-center text-slate-700 tracking-widest grow uppercase font-bold">Охридско Зборче</h1>
